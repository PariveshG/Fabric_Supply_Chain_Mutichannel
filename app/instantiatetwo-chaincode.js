...
const instantiateChaincode = async function(peers, channelName, chaincodeName, chaincodeVersion, chaincodeType, functionName,  username, org_name) {
	...
	try {
		...
		const request = {
			...
			args:["Trade2","PartyA","PartyB","50","Submitted"],
			txId: tx_id,
