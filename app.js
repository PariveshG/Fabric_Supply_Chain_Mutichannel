...
var instantiatetwo = require('./app/instantiatetwo-chaincode.js');
...
app.post('/channels', async function(req, res) {
	...
	let message = await createChannel.createChannel(channelName, channelConfigPath, 'Jim', 'Org1');
	res.send(message);
});
// Join Channel
...
app.post('/channels/:channelName/chaincodes', async function(req, res) {
	...
	logger.debug('channel12 inside=====================================');
	let message = await instantiatetwo.instantiateChaincode(peers, channelName, chaincodeName, chaincodeVersion, chaincodeType, fcn, username, orgname);
	res.send(message);
	}else{
 	logger.debug('channelall inside====================================='+ channelName);
 	 let message = await instantiate.instantiateChaincode(peers, channelName, chaincodeName, chaincodeVersion, chaincodeType, fcn, username, orgname);
        res.send(message);
}
